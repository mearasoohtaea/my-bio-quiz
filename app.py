...
# 已深度剔除重复题，完美融合老35道题与新PDF题库，共44道精编核心题
questions = [
  {
    "id": 1,
    "question": "1. 병원균과 같은 감염원이 우리 몸 안으로 침입했을 때, 우리 몸의 면역 체계는 이러한 감염원이 이물질이고 “비자기(non-self)”인지 어떤 방식으로 결정하는가?\n(When pathogens, such as infectious agents, invade our body, how does the immune system determine that these invaders are foreign and \"non-self\"?) [cite: 44]",
    "options": {"1": "DNA 서열을 분석함으로써 (By analyzing DNA sequences)", "2": "세포 수를 계산하여 (By counting the number of cells)", "3": "감염원과 관련된 분자 패턴을 탐지함으로써 (By detecting molecular patterns associated with infectious agents) [cite: 44]", "4": "체온을 평가하여 (By assessing body temperature)"},
    "answer": "3"
  },
  {
    "id": 2,
    "question": "2. 알레르기 항원 (allergen)이 혈액을 떠돌며 전신의 면역 체계를 활성화할 경우 여러 과정을 거쳐 히스타민 (histamine)이 방출되어 아나필락시스를 유발할 수 "
                "있다. 아나필락시스 동안 히스타민 방출의 원인은 무엇인가?\n(What is the source of histamine release during anaphylaxis?) [cite: 57]",
    "options": {"1": "에피네프린 주사 (Epinephrine injection)", "2": "대식세포 (Macrophages)", "3": "비만세포의 폭발적인 탈과립화 (Explosive degranulation of mast cells) [cite: 57]", "4": "간에서 생산 (Production by the liver)"},
    "answer": "3"
  },
  {
    "id": 3,
    "question": "3. 항온동물은 체온을 일정하게 유지함으로써 진화적 이점을 얻었다. 항온동물은 변온동물과 비교할 때, 에너지 소비와 생존 능력에 있어 어떤 환경에서 어떤 "
                "진화적 이점을 가지게 되었는가?\n(Endotherms have gained an evolutionary advantage by maintaining a constant body temperature.)",
    "options": {"1": "항온동물은 변온동물보다 더 많이 먹어야 한다.", "2": "항온동물은 오랫동안 먹지 않고도 살 수 "
                                                                        "있다.", "3": "항온동물은 더 추운 기후에서 살 수 있다. (Endotherms can live in colder climate.)", "4": "항온동물은 변온동물보다 작아질 수 있다.", "5": "항온동물은 낮에 변온동물과 더 잘 먹기 위해 경쟁할 수 있다."},
    "answer": "3"
  },
  {
    "id": 4,
    "question": "4. 사람이 ‘나는 이 일을 하도 오랫동안 해 와서 눈 감고도 할 수 있어.’ 라고 말했다면 이 사람은 어떤 일을 하는 건 아마도 굳이 눈으로 보지 "
                "않고도 내 팔과 다리가 어느 위치에 어떤 상태인지 알 수 있기 때문일 것이다. 이것은 어떤 감각에 해당하는가?\n(What is this sensation called?)",
    "options": {"1": "시각 (Vision)", "2": "후각 (Olfaction)", "3": "촉각 (Tactile sensation)", "4": "고유감각 (Proprioception)", "5": "내수용감각 (Interoception)"},
    "answer": "4"
  },
  {
    "id": 5,
    "question": "5. 수면의 여러 단계 중 하나로, 이 단계에서는 눈이 빠르게 움직이고 뇌파 활동이 활발하며 기억의 공고화에 중요한 역할을 한다고 알려져 있다. "
                "또한 이 단계에서는 꿈이 활발하게 일어나고 비교적 잘 기억할 수 있다. 이 단계의 수면을 무엇이라고 하는가?\n(What is this stage of sleep called?)",
  ...
  },
  {
    ...
    "question": "6. 인플루엔자 바이러스가 갖고 있는 단백질 중 하나로, 숙주 세포의 표면에 붙어서 바이러스가 세포 안으로 들어가도록 돕는 것은 무엇인가?\n(Which "
                "protein found in the influenza virus helps the virus attach to the surface of host cells?)",
    "options": {"1": "헤마글루티닌 (Hemagglutinin)", "2": "뉴라민분해효소 (Neuraminidase)", "3": "복제효소 (Polymerase)", "4": "캡시드 단백질 (Nucleocapsid)"},
    "answer": "1"
  },
  {
    "id": 7,
    "question": "7. SARS-CoV-2 (COVID-19) 는 주로 호흡을 통해 다른 사람에게 전파되기 때문에, 2019년 말에 시작된 팬데믹 이후로 정부에서 마스크 "
                "착용을 의무화하였다. 이것은 바이러스의 어떠한 감염 방식인가?\n(What type of infection method does this represent?)",
    "options": {"1": "비말감염 (droplet infection)", "2": "곤충 매개 감염 (insect-mediated infection)", "3": "혈액 감염 (blood infection)", "4": "성적 접촉 (sexual contact)"},
    "answer": "1"
  },
  {
    "id": 8,
    "question": "8. 특정 질병의 다양한 변종 또는 여러 관련 질병에 대해 폭넓은 면역 보호를 제공하는 백신인 범용백신 (universal vaccine)에 대한 "
                "설명으로 옳지 않은 것은 무엇인가?\n(Which of the following is incorrect regarding the universal vaccine?)",
    "options": {"1": "범용백신은 특정 질병에 대해 장기적인 면역을 제공하기 위해 개발된다.", "2": "범용백신은 여러 바이러스의 변종에 대해 동시에 면역을 생성할 수 있도록 설계된다.", "3": "범용백신은 한 가지 백신으로 모든 질병을 예방할 수 있도록 개발된다.", "4": "범용백신은 기존 백신보다 면역 반응을 보다 넓은 범위에서 유도하도록 목표로 한다."},
    "answer": "1"
  },
  {
    "id": 9,
    "question": "9. 혈액에서 혈구 (적혈구, 백혈구, 혈소판)와 혈장을 제거하고 남은 투명한 액체로... 호르몬 검사를 하거나 질병을 진단할 때 중요한 역할을 "
  ...
  {
    "id": 10,
    "question": "10. 다음 설명에 알맞은 용어를 고르시오.\n[생물체 내에서 산화스트레스를 받아서 생성되는 산소의 화합물로, 생체 조직을 공격하고 세포를 손상시키며 "
                 "노화를 일으키는 산화력이 강한 산소.]",
  ...
  {
    "id": 11,
    "question": "11. 다음 중 잠이 가지는 기능으로 보기 어려운 것은? (Which of the following is least likely to be considered "
                 "a function of sleep?)",
  ...
  },
  {
    ...
    "question": "14. 체세포에서 일어나는 일반적인 분열과 다르게 생식세포에서는 두 번의 분열로 4개의 반수체가 생성되는 분열 방식의 명칭은?\n(What is this "
                 "division process in gamete cells called?)",
    "options": {"1": "반수분열 (haploid division)", "2": "유사분열 (mitosis)", "3": "감수분열 (meiosis)", "4": "세포질분열 (cytokinesis)"},
    "answer": "3"
  },
  {
    "id": 15,
    "question": "15. 찰스 다윈은일부 특성은 생존과 번식 성공을 촉진할 가능성이 더 높으며, 따라서 이러한 특성이 다음 세대로 전달됨을 주장하였는데, 이를 뜻 "
  ...
  },
  {
    ...
    "question": "20. 뇌의 기저핵에서 분비되며 보상, 동기 부여, 감정 조절에 관여하고 '행복 호르몬'이라 불리는 물질 A는 무엇인가?\n(Often called a "
                 "'happiness hormone,' involved in reward and motivation. What is substance A?)",
  ...
  {
    "id": 23,
    "question": "23. 인체와 오랜 기간 공동 진화를 거쳐온 미생물 집단으로, 면역 기능 조절และ 소화를 돕는 이것은 무엇인가?\n(Collection of "
                 "microorganisms part of human body over long period of co-evolution...?)",
  ...
  },
  {
    ...
    "options": {"1": "올리고뉴클레오타이드", "2": "텔로미어(Telomere)", "3": "텔로머레이즈", "4": "셀터린 복합체"},
    "answer": "2"
  },
  {
    "id": 28,
  ...
  {
    "id": 32,
    "question": "32. 알츠하이머병 환자가 기억 상실, 길 잃음 등의 증상을 보일 때 주로 손상된 뇌 영역은?\n(What is the brain area primarily "
                 "associated with memory loss in Alzheimer's?)",
  ...
  {
    "id": 34,
    "question": "34. 다음 중 유도만능줄기세포(iPSC) 기술로 인해 해결된 문제가 아닌 것은?\n(Which of the following is not an issue resolved "
                 "by the advent of iPSC technology?)",
  ...
  # === 以下为新提取并清洗去重后的高级核心题库 (题号 36-44) ===
  {
    "id": 36,
    "question": "36. 다음 용어에 알맞은 설명을 고르시오. Choose the appropriate description for the following terminology.\n[ RNA virus (알엔에이 바이러스) / RNA病毒 ] [cite: 229, 230]",
    "options": {
      "1": "유전 물질로 아르엔에이를 가지고 있는 바이러스. (A virus in which the genetic information is stored in the form of RNA (as opposed to DNA).) / 遗传信息以RNA形式存储的病毒(与DNA相反) [cite: 236, 237, 238]",
  ...
  {
    "id": 37,
    "question": "37. 다음 용어에 알맞은 설명을 고르시오. Choose the appropriate description for the following terminology.\n[ 촉진 확산 (facilitated diffusion) / 促进扩散 ] [cite: 242, 243]",
    "options": {
      "1": "에너지를 소모하여 물질을 농도 경사에 역행하여 수송하는 현상. (Active transport utilizing ATP.)",
      "2": "이동은 물질과 막에 포함된 채널 또는 단백질 사이의 결합에 의존한다. (The transport relies on binding between the matter and the membrane-embedded channel or carrier protein.) / 运输依赖于物质与膜内包含的通道或载体蛋白的结合作用。 [cite: 246, 247, 248]",
  ...
  {
    "id": 38,
    "question": "38. 암세포가 전이하기 위하여 상피세포의 특징을 잃고 중간엽세포의 특징을 얻는 과정은 무엇인가?\n(What is the process that cancer cells do for metastasis by changing from an epithelial cell into a mesenchymal cell?) / 癌细胞在转移前会失去上皮细胞的特性并获得间充质细胞的特征,这一过程是什么? [cite: 255, 256, 257]",
    "options": {
      "1": "EMT (epithelial-mesenchymal transition) / 上皮-间充质转化(EMT) [cite: 260]",
      "2": "Apoptosis / 细胞凋亡",
      "3": "Angiogenesis / 血管生成",
      "4": "Endocytosis / 胞吞作用"
    },
  ...
  {
    "id": 39,
    "question": "39. 다음 설명에 알맞은 용어를 고르시오. Choose the appropriate term for the following description.\n[ 진핵세포에 존재하는 대형의 구상 내지는 타원형의 구조, 세포의 여러 가지 활동을 규정하는 유전자를 내부에 포함한다. 적혈구를 제외하고 거의 모든 세포에 존재하는 세포 소기관. ] / 真核细胞中存在的大型球形或椭圆形结构,包含调节各种细胞活动的基因,几乎存在于除红细胞外的所有细胞中 [cite: 266, 267, 268, 269]",
    "options": {
      "1": "미토콘드리아 (mitochondria) / 线粒体",
      "2": "리보솜 (ribosome) / 核糖体",
      "3": "핵 (nucleus) / 细胞核 [cite: 273]",
  ...
  {
    "id": 40,
    "question": "40. 세포막에 대한 설명 중 틀린 것은? (Which of the following statements concerning the cell membrane is false?) / 下列关于细胞膜的叙述错误的是? [cite: 277, 278]",
    "options": {
      "1": "세포막은 지질 2중층으로 구성되어 있다. (Cell membrane consists of a lipid bilayer.)",
      "2": "어떤 물질도 세포막을 통과할 수 없다. (No substance can pass through the cell membrane.) / 没有物质可以通过细胞膜 [cite: 282]",
  ...
  {
    "id": 41,
    "question": "41. 다음 중 이차 능동수송에 대한 설명은? (Which of the following explanations is secondary active transport?) / 下列哪一项是关于次级主动运输的描述? [cite: 285, 287]",
    "options": {
      "1": "분자가 농도 경사를 따라 이동할 때, 다른 분자는 농도경사를 거슬러 이동한다. (A molecule is moved down its concentration gradient as another is moved up its concentration gradient.) / 分子沿着浓度阶梯移动,而其他分子则逆着浓度阶梯移动 [cite: 289, 290, 291]",
  ...
  {
    "id": 42,
    "question": "42. 다음 중 모든 생명체의 기본 구성요소는? (Which of the following examples is the basic building block of all living things?) / 下列哪一项是所有生命体的基本组成部分? [cite: 293, 295]",
    "options": {
      "1": "조직 (tissue) / 组织",
      "2": "기관 (organ) / 器官",
      "3": "세포 (cell) / 细胞 [cite: 297]",
      "4": "원자 (atom) / 原子"
    },
    "answer": "3"
  },
  {
    "id": 43,
    "question": "43. 다음 중 사회적 감정으로 간주될 수 있는 것은? (Which of the following can be regarded as social emotion?) / 下列哪一项可以被视为社会感情? [cite: 301, 303]",
    "options": {
      "1": "공포 (Fear) / 恐惧",
      "2": "분노 (Anger) / 愤怒",
      "3": "죄책감 (Guilt) / 内疚感 [cite: 305]",
      "4": "기쁨 (Joy) / 喜悦"
    },
    "answer": "3"
  },
  {
    "id": 44,
    "question": "44. 다음 중 화학적 발암물질이 아닌 것은? (Which of the following is not a chemical carcinogen?) / 下列哪一项不是化学致癌物质? [cite: 309, 312]",
    "options": {
      "1": "벤젠 (Benzene)",
      "2": "방사선 (ionizing radiation) / 辐射 [cite: 314]",
...
if idx < total_q:
    ...
    st.balloons()
    st.success("🎉 恭喜你！全套 44 道生命科学期末考试题已全部复习完毕！")
